...
def main():
    fixthiswhenfound = { #fix (overwrite) old, wrong or poor translations
        ...
        'village in China': {
            'az': ['çində kənd'],
            'bar': ['dorf in Kina', 'dork in Kina'],
            'bn': ['চীনের গ্রাম'], #https://www.wikidata.org/w/index.php?title=User_talk:Emijrp&diff=prev&oldid=510797889
            'cdo': ['中國其村'],
            'cy': ['Pentref yn Tsieina'],
            'da': ['lands by i Kina'],
            'eo': ['vilaĝo en Ĉinujo'],
            'et': ['hiina küla', 'Hiina küla'],
            'eu': ['txinako herria'],
            'fi': ['kiinalainen kylä'], #https://www.wikidata.org/w/index.php?title=User_talk:Emijrp&diff=468197059&oldid=463649230
            'fy': ['Doarp yn Sina'],
            'gsw': ['Dorf in Kina', 'dorf in Kina'],
            'hr': ['ଚୀନର ଗାଁ'],
            'id': ['desa di Cina'],
            'lzh': ['中國其村'],
            'mai': ['“चीनक गाम “'],
            'pl': ['wieś w Chinac', 'küla Hiinas'],
            'pcd': ['saarep uun Schiina'],
            'pfl': ['Doaf in China', 'doaf in China'],
            'rgn': ['saarep uun Schiina'],
            'sr': ['Село у Кини', 'चीनक गाम'],
            'st': ['motseng o China'],
            'tr': ['çin′de bir köy'],
            'uz': ['xitoydagi qishloq'],
            'vi': ['Ngôi làng ở Trung Quốc'],
            'yo': ['Abúlé ní China'],
        }, 
        'Wikimedia category': {
