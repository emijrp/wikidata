...
def main():
    statements = [
        { 'p31': 'Q5', 'p21': 'Q6581072', 'p27': 'Q183', 'p106': 'Q36180', '@en': 'German writer' } #female German writers
    ]
    translations = {
        'German writer': {
    ...
    for statement in statements:
        for lang in translations[statement['@en']].keys():
            ...
            for result in json1['results']['bindings']:
                ...
                print('%s\tD%s\t"%s"' % (q, lang, translations[statement['@en']][lang]))
