...
def addMetadata(pagetitle='', newtext='', pagelink=''):
    ...
    topics = [
        ...
        ["buildings-ports", 
            ["puerto", "lonja", "seaport", "seaports", "shipyard", "shipyards", ], 
            ["puerto de santa", "puerto santa"], 
        ], 
        ["buildings-religion", 
        ...
        ["buildings-roads", 
            ["carretera", "carreteras", "road", "roads", "road signs", ], 
            [], 
        ], 
        ...
        ["buildings-towers", 
            ["torre", "torres", "torreon", "torreones", "tower", "towers"], 
            [], 
        ], 
        ["events-carnival", 
        ...
        ["events-demonstrations", 
            ["manifestacion", "manifestaciones", "marcha contra", "19jmani", "protesta", "protestas"], 
            [], 
        ], 
        ["events-disasters", 
        ...
        ["weather", 
            ["lluvia", "nieve", "nube", "nubes", "temporal", "viento", "rain", "snow", "weather"], 
            [], 
        ], 
